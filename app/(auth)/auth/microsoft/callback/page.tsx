    ...
    const handleCallback = async () => {
      try {
        ...
        const response = await fetch(`${API_URL}/api/oauth/callback`, {
          ...
          body: JSON.stringify({ code, provider: "microsoft" })
        })
        ...
        setStatus("success")
        showSuccess("Successfully logged in with Microsoft!")
      ...
      <div className="text-center">
        {status === "loading" && (
          <>
            ...
            <h2 className="text-xl font-bold mb-2">Connecting with Microsoft...</h2>
